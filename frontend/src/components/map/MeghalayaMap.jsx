  ...
  useEffect(() => {
    ...
    const loadMap = async () => {
      try {
        ...
        // -----------------------------------------------
        // Load Google Maps using modern importLibrary
        // -----------------------------------------------
  ...
  const searchPlace = async () => {
    ...
    try {
      ...
      if (!places || places.length === 0) {
        setError(
          `"${query}" was not found in Meghalaya.`
        );
        return;
      }
      ...
      const marker =
        new googleRef.current.AdvancedMarkerElement({
    ...
    <div className="relative h-[650px] w-full overflow-hidden bg-gray-100">
      ...
      <div className="absolute right-4 top-4 z-30 flex flex-col gap-2">
        ...
        <button
          ...
          title="Road map"
          className={`flex h-11 w-11 items-center justify-center rounded-xl border shadow-lg ${mapType === "roadmap"
        ...
        <button
          ...
          title="Satellite"
          className={`flex h-11 w-11 items-center justify-center rounded-xl border shadow-lg ${mapType === "satellite"
            ? "border-[#183c2c] bg-[#183c2c] text-white"
            : "border-gray-200 bg-white text-gray-600 hover:bg-gray-50"
            }`}
        >
        ...
        <button
          onClick={locateMe}
          title="My location"
          className="flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-600 shadow-lg hover:bg-gray-50"
        >
          <LocateFixed size={18} />
        </button>
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-base font-semibold text-[#17221d]">
                    {selectedPlace.name}
                  </p>
            ...
            {selectedPlace.location && (
              <div className="mt-3 rounded-xl bg-[#f7f7f3] px-3 py-2">
                ...
                <p className="mt-1 text-xs text-gray-600">
                  {selectedPlace.location.lat.toFixed(5)}
                  {" , "}
                  {selectedPlace.location.lng.toFixed(5)}
                </p>
