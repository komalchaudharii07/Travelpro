...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Backend login API yahan connect hoga
      ...
      <div className="grid min-h-screen overflow-hidden bg-white md:min-h-[calc(100vh-24px)] md:grid-cols-[65%_35%] md:rounded-sm">
        ...
        <section className="relative hidden overflow-hidden md:block">
          ...
          {/* =================================================
              IMAGE CONTENT
          ================================================== */}
          <div className="absolute bottom-9 left-9 z-20 max-w-[520px] xl:left-11 xl:bottom-11">
          ...
          <div className="w-full max-w-[350px]">
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <Link
                  to="/forgot-password"
                  className="text-[13px] text-gray-500 underline underline-offset-2 transition hover:text-emerald-700"
                >
                  Forgot Password
                </Link>
            ...
            <div className="space-y-2">
              ...
              <button
                type="button"
                className="flex h-[41px] w-full items-center justify-center gap-2.5 rounded-md border border-gray-200 bg-white text-[13px] font-medium text-gray-600 transition hover:border-gray-300 hover:bg-gray-50 active:scale-[0.99]"
              >
            ...
            <p className="mt-6 text-center text-[12px] text-gray-500">
              ...
              <Link
                to="/signup"
                className="font-medium text-[#183c2c] transition hover:text-emerald-700"
              >
                Create Account
              </Link>
            ...
            {/* =================================================
                TERMS
            ================================================== */}
            <p className="mt-6 text-center text-[9px] leading-4 text-gray-500">
