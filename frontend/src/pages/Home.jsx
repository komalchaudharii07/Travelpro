      ...
      <header className="absolute left-0 right-0 top-0 z-50">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <Link
              to="/"
              className="text-sm font-medium text-white transition hover:text-emerald-200"
            >
              Home
            </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/signup"
              className="rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-[#183c2c] shadow-sm transition hover:bg-emerald-50"
            >
              Get started
            </Link>
